...
filtered_data = merged_df[(merged_df['Average Property Value'] > mean - 2*std) & (merged_df['Average Property Value'] < mean + 2*std)]

plt.scatter(filtered_data['Average Property Value'], filtered_data['Tree Count'], color='green')
